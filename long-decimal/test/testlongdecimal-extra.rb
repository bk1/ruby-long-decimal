...
class TestLongDecimalExtra_class < UnitTest # Test::Unit::TestCase # RUNIT::TestCase
  ...
  def test_lm_power1m
    print "\ntest_lm_power1m [#{Time.now}]: "
    #   1) Failure:
    # TestRandomPower_class#test_random_power [test/testlongdeclib.rb:512]:
    # x=0.99999999999999994420000000000000311246999999999982638945999999630968382654210041237984560328258547738328525977811523852626316219
    # y=468239690552160129.
    # z=0.000000000000
    # z_dp=0.0000000000044962619919208
    # prec=12
    check_power_floated(LongDecimal("0.99999999999999994420000000000000311246999999999982638945999999630968382654210041237984560328258547738328525977811523852626316219"),
                        LongDecimal("468239690552160129."),
                        12)
    puts "m"
  end
  ...
  def test_lm_power1n
    ...
    #   1) Failure:
    # TestRandomPower_class#test_random_power [test/testlongdeclib.rb:512]:
    # x=0.99999999999999999999999999999999999999986798647999999999998420000000000000000001307067709709280000312872042400000000018607966260508626513648296660373186751995066112985623137014533895555589909252710075789173197480230570830334488316102943800582003593
    # y=616626415978207405.864740805067280536640838937552448238534760345550030324310813292930293773147067188934152956030978947408331004344826301955511237478970918727893739076966725363727164875164618250179475101131733551483059962544
    # z=1.00000000000
    # z_dp=0.00000000000000000000000
    # prec=11
    check_power_floated(LongDecimal("0.99999999999999999999999999999999999999986798647999999999998420000000000000000001307067709709280000312872042400000000018607966260508626513648296660373186751995066112985623137014533895555589909252710075789173197480230570830334488316102943800582003593"),
                        LongDecimal("616626415978207405.864740805067280536640838937552448238534760345550030324310813292930293773147067188934152956030978947408331004344826301955511237478970918727893739076966725363727164875164618250179475101131733551483059962544"),
                        11)
    puts "n"
  end


# Finished in 7228.772996s, 0.0001 runs/s, 48.3645 assertions/s.

#   1) Failure:
# TestRandomPower_class#test_random_power [test/testlongdeclib.rb:512]:
# x=0.99999999999999982843097133808784264116551840771998778159116664877791549691066021273527121263967864082665660008199027385403208627229289815450645373676193042483394257554644426772748212705679823635261601441247714442145659743015
# y=417946156446102686.
# z=0.0000000000000000000000000000000000000
# z_dp=0.000000000000000000000000000000072146009432260721079022784497974363475189145
# prec=37

# 1 runs, 349616 assertions, 1 failures, 0 errors, 0 skips
# bk1@eisvogel:~/projekte/ruby/long-decimal/ruby/ruby-long-decimal/long-decimal>

# Finished in 14993.109322s, 0.0001 runs/s, 52.3087 assertions/s.

#   1) Failure:
# TestRandomPower_class#test_random_power [test/testlongdeclib.rb:512]:
# x=0.
# y=608580077363357089.1173473277226358099830894813799597277365264561912064964817511671503274851468892084678740779327832087034724078561328882421839164725748428430157177852461510335293531222782685
# z=0.0000000000000000000000000000
# z_dp=0.999999999999999999999999999999999999999999999999203879886
# prec=28

# 1 runs, 784270 assertions, 1 failures, 0 errors, 0 skips

#   1) Failure:
# TestRandomPower_class#test_random_power [test/testlongdeclib.rb:512]:
# x=0.
# y=1047197551196597746.
# z=0.0000000000000000000000000000000000000000
# z_dp=0.542626884013031809062411155939237700480935970255646531391849882041902492292852146
# prec=40

# 1 runs, 238467 assertions, 1 failures, 0 errors, 0 skips
#   1) Failure:
# TestRandomPower_class#test_random_power [test/testlongdeclib.rb:541]:
# delta=4.79776981621759e-12 z=0.000057054093236833984771945=5.705409323683399e-05 and wf=5.7054082239134874e-05 should be almost equal
# x=0.0.9999999919599999
# y=1215362034.28298882818117117513384819279476169277417892638143225152912645217518706354=1215362034.2829888
# delta=4.79776981621759e-12
# l=20.918307839957784
# diff=1.0997699116405829e-11
# prec=27
# corr=4.4.0199999757594
# corr2=8.8.0399999515188
# corr_f=4.0199999757594.
# Expected: 5.705409323683399e-05
#   Actual: 5.7054082239134874e-05
